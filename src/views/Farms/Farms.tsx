...
const Farms: React.FC = ({ children }) => {
  ...
  return (
    <FarmsContext.Provider value={{ chosenFarmsMemoized }}>
      <PageHeader>
        <Heading as="h1" scale="xxl" color="#FABB18" mb="24px">
          {t('Farms')}
        </Heading>
        <Heading scale="lg" color="#010101">
          ...
          <ViewControls>
            ...
            <ToggleWrapper>
              <Toggle
                ...
                scale="sm"
              />
              <Text color='#010101'> {t('Staked only')}</Text>
            </ToggleWrapper>
            <FarmTabButtons hasStakeInFinishedFarms={stakedInactiveFarms.length > 0} />
          </ViewControls>
          <FilterContainer>
            <LabelWrapper>
              <Text textTransform="uppercase" color='#010101'>{t('Sort by')}</Text>
              <Select
                options={[
                  {
                    label: t('Hot'),
            ...
            <LabelWrapper style={{ marginLeft: 16 }}>
              <Text textTransform="uppercase" color='#010101'>{t('Search')}</Text>
